...
plot(theta_pE(1:50:end) * 180/pi, RE0_ang{2}(1:50:end), 'color', Xb2, 'linestyle', 'none', 'marker', '+', 'markersize', 15, 'linewidth', 3)
...
plot(theta_pI(1:10:end) * 180/pi, RI0_ang{2}(1:10:end), 'color', Xb2, 'linestyle', 'none', 'marker', '+', 'markersize', 15, 'linewidth', 3)
...
plot(theta_pE(1:50:end) * 180/pi, RE0_std_ang{2}(1:50:end), 'color', Xb2, 'linestyle', 'none', 'marker', '+', 'markersize', 15, 'linewidth', 3)
...
plot(theta_pI(1:10:end) * 180/pi, RI0_std_ang{2}(1:10:end), 'color', Xb2, 'linestyle', 'none', 'marker', '+', 'markersize', 15, 'linewidth', 3)
...
print(h1, 'TuningCurves_TunedExtIn', '-dsvg', '-r0')
    
    
set(h2, 'Units', 'Inches');
pos = get(h2, 'Position');
set(h2, 'PaperPositionMode', 'Auto', 'PaperUnits', 'Inches', 'PaperSize', [pos(3), pos(4)]);
print(h2, 'InputCurrents_TunedExtIn', '-dsvg', '-r0')

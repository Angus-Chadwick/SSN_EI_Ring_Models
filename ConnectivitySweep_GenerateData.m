...
set(gca, 'ydir', 'normal')
set(gca, 'clim', [0,10])
axis([0, (Nvals - 26)/20, (1-26)/20, (Nvals - 26)/20])
xlabel('Tuning of E to I connections (k_{IE})')
ylabel('Tuning of I to E connections (k_{EI})')
title('Single-Cell Selectivity (Pyramidal)')
h = colorbar;
set(h, 'fontsize', 18)
...
xlabel('Tuning of E to I connections (k_{IE})')
ylabel('Tuning of I to E connections (k_{EI})')
title('Single-Cell Selectivity (Interneuron)')
h = colorbar;
set(h, 'fontsize', 18)
...
xlabel('Tuning of E to I connections (k_{IE})')
ylabel('Tuning of I to E connections (k_{EI})')
title('Population Selectivity (Pyramidal)')
h = colorbar;
set(h, 'fontsize', 18)
...
ylabel('I to E tuning (k_{EI})')
title('Average Single-Cell Selectivity (E cells)')
h = colorbar;
set(h, 'fontsize', 18)
...
xlabel('E to I tuning (k_{IE})')
ylabel('I to E tuning (k_{EI})')
title('Average Single-Cell Selectivity (I cells)')
h = colorbar;
set(h, 'fontsize', 18)

subplot(2,2,3)

h = imagesc(([1:Nvals] - 26) /20, ([1:Nvals] - 26) /20, log(sqrt(SItot_E) .* (SItot_E > 0)))
set(h, 'AlphaData', ~isnan(SItot_E))
set(gca, 'fontsize', 18)
set(gca, 'ydir', 'normal')
set(gca, 'clim', [0,4])
xlabel('E to I tuning (k_{IE})')
ylabel('I to E tuning (k_{EI})')
title('Population Selectivity (E cells)')
h = colorbar;
set(h, 'fontsize', 18)

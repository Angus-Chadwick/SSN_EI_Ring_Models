...
for nEI = 1:Nvals % loop through I to E connection specificity
    nEI
    for nIE = 26:Nvals % loop through E to I connection specificity
    

    for q=1:Nstim  % simulate responses to different stimuli

% create network        

kIE = 1 *  (nIE - 26) /20; % E to I concentration
kEI = 1 *  (nEI - 26) /20; % I to E concentration
